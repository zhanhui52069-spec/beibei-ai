  ...
  en: {
    ...
    pages: {
      ...
      feedback: {
        ...
        description:
          "Share the workflow, feature, or page change that would make NexusAI more useful for your selling work.",
      },
    },
    feedback: {
      name: "Name",
      ...
      message: "Suggestion",
      messagePlaceholder: "Tell us what you want improved, added, or removed...",
      submit: "Send feedback",
      submitting: "Sending...",
      success: "Thanks. Your feedback has been recorded.",
      error: "Feedback could not be sent. Please try again.",
      roles: ["Seller", "Agency", "Creator", "Buyer", "Other"],
      categories: ["Feature request", "Bug report", "Pricing", "Content/templates", "Design", "Other"],
      note: "Feedback is used to decide what to improve next. Please do not include passwords or API keys.",
    },
    chatPage: {
  ...
  zh: {
    ...
    pages: {
      ...
      feedback: {
        eyebrow: "意见箱",
        title: "告诉我们下一步该做什么",
        description: "把你希望 NexusAI 改进、增加或删除的功能告诉我们，帮助我们按真实需求迭代。",
      },
    },
    feedback: {
      name: "姓名",
      ...
      category: "反馈类型",
      message: "建议内容",
      messagePlaceholder: "告诉我们你希望改进、增加或删除什么...",
      submit: "提交反馈",
      submitting: "提交中...",
      success: "谢谢，你的反馈已经记录。",
      error: "反馈提交失败，请稍后重试。",
      roles: ["卖家", "服务商", "创作者", "买家", "其他"],
      categories: ["功能建议", "问题反馈", "价格方案", "内容/模板", "界面设计", "其他"],
      note: "反馈会用于决定下一步优化方向。请不要填写密码或 API Key。",
    },
    chatPage: {
